...
$sql = 'SELECT lokasiuji_sumur_id,alamat, nama_lokasi,kecamatan_nama,kelurahan_nama,lat,lng,icon_map,CONCAT("<b>LOKASI UJI SUMUR</b><br>Lokasi :",nama_lokasi,"<br>Kecamatan :",kecamatan_nama,"<br>Kelurahan :",kelurahan_nama) As description,lng AS x, lat AS y  FROM lokasiuji_sumur sm, kelurahan k, kecamatan c where sm.kelurahan_id = k.kelurahan_id AND k.kecamatan_id = c.kecamatan_id';
