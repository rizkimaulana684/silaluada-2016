...
echo form_open_multipart('adm_biogas/edit');
echo form_hidden('id',$item['biogas_id']);
?>
<div class="box">
    ...
    <div class="box">
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="nama_kepemilikan" value="<?php echo $item['nama_pemilik'] ?>" class="form-control">
        </div>
        <div class="form-group">
          <label>Umur</label>
          <input type="text" name="umur" value="<?php echo $item['umur'] ?>" class="form-control">
        </div>
        <div class="form-group">
          <label>Tahun Pembuatan*</label>
          <input type="text" name="tahun_pembuatan" value="<?php echo $item['tahun_pembuatan']?>" class="form-control" id="dp2">
        </div>
        <div class="form-group">
          <label>Sumber Energi*</label>
          <input type="text" name="sumber_energi" value="<?php echo $item['sumber_energi'] ?>" class="form-control">
        </div>
        <div class="form-group">
  ...
  <div class="col-md-5">
    <div class="box">
      <div class="box-body">
        ...
        <div class="form-group">
          <label>Kampung</label>
          <input type="text" name="kampung" value="<?php echo $item['kampung'] ?>" class="form-control">
        </div>
        <div class="form-group">
          <label>foto</label>
        ...
        <?php
        if($item['foto']!='') {
          echo "<img src='".base_url('uploads/ragamdata/upaya_pengendalian/biogas/thumb/'.$item['foto'])."' />";
        }
        ?>
	<!--	<div class="form-group">
          <label>marker color</label>
          
          <input type="text" readonly name="marker-color" value="<?php echo $item['marker-color'] ?>" class="form-control ">
        </div>
		<div class="form-group">
