...
echo form_open_multipart('adm_mata_air/edit');
echo form_hidden('id',$item['mata_air_id']);
?>
<div class="box">
  <div class="box-header text-right">
      <button type="submit" class="btn btn-sm bg-orange"><i class="fa fa-save"></i> Simpan</button>
      <button type="reset" class="btn btn-sm btn-default"> Reset</button>
      <a href="<?php echo site_url('adm_mata_air')?>" class="btn btn-sm bg-grey">Kembali</a>
  </div>
</div>
<div class="row">
  <div class="col-md-7">
  ...
  <div class="col-md-5">
    <div class="box">
      <div class="box-body">
        ...
        <?php
        if($item['foto']!='') {
          echo "<img src='".base_url('uploads/ragamdata/konservasi/mata_air/thumb/'.$item['foto'])."' />";
        }
        ?>
		<div class="form-group">
