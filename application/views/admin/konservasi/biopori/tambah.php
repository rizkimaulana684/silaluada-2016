...
echo form_open_multipart('adm_biopori/tambah');
?>
<div class="box">
  ...
  <div class="col-md-7">
    <div class="box">
      <div class="box-body">
        ...
        <div class="form-group">
          <label>Jumlah*</label>
          <input type="text" name="jumlah" value="<?php echo set_value('jumlah') ?>" class="form-control">
          <p class="help-block text-red"><?php echo form_error('jumlah', ' ')?></p>
        </div>
        <div class="form-group">
