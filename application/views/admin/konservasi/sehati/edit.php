...
echo form_open_multipart('adm_sehati/edit');
...
<div class="box">
  <div class="box-header text-right">
      ...
      <a href="<?php echo site_url('adm_sehati')?>" class="btn btn-sm bg-grey">Kembali</a>
  </div>
</div>
<div class="row">
  <div class="col-md-7">
    ...
    <p><b><font face="Arial">Data Lokasi Pengujian SEHATI</font></b></p>
  ...
  <div class="col-md-5">
    <div class="box">
      <div class="box-body">
        ...
        <?php
        if($item['foto']!='') {
          echo "<img src='".base_url('uploads/ragamdata/konservasi/sehati/thumb/'.$item['foto'])."' />";
        }
        ?>
		<!--<div class="form-group">
