...
echo form_open_multipart('adm_perusahaan_pengguna_air/edit');
echo form_hidden('id',$item['pemanfaatan_air_id']);
?>
<div class="box">
    ...
    <div class="box">
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="debit_air" value="<?php echo $item['debit_air'] ?>" class="form-control">
        </div>
        <div class="form-group">
          <label>Alamat*</label>
