...
echo form_open_multipart('adm_sumur_imbuhan/edit');
echo form_hidden('id',$item['sumur_imbuhan_id']);
?>
<div class="box">
  ...
  <div class="col-md-5">
    <div class="box">
      <div class="box-body">
        ...
        <?php
        if($item['foto']!='') {
          echo "<img src='".base_url('uploads/ragamdata/konservasi/sumur_imbuhan/thumb/'.$item['foto'])."' />";
        }
        ?>
		<!--<div class="form-group">
