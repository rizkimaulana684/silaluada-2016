...
echo form_open_multipart('adm_sumur_pantau/edit');
echo form_hidden('id',$item['sumur_pantau_id']);
?>
<div class="box">
  <div class="box-header text-right">
      <button type="submit" class="btn btn-sm bg-orange"><i class="fa fa-save"></i> Simpan</button>
      <button type="reset" class="btn btn-sm btn-default"> Reset</button>
      <a href="<?php echo site_url('adm_sumur_pantau')?>" class="btn btn-sm bg-grey">Kembali</a>
  </div>
</div>
<div class="row">
  <div class="col-md-7">
    <div class="box">
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="tinggi_air" value="<?php echo $item['tinggi_air'] ?>" class="form-control">
        </div>
        <div class="form-group">
  ...
  <div class="col-md-5">
    <div class="box">
      <div class="box-body">
        ...
        <?php
        if($item['foto']!='') {
          echo "<img src='".base_url('uploads/ragamdata/konservasi/sumur_pantau/thumb/'.$item['foto'])."' />";
        }
        ?>
		<div class="form-group">
