...
echo form_open_multipart('adm_sumur_pantau/tambah');
?>
<div class="box">
    ...
    <div class="box">
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="tinggi_air" value="<?php echo set_value('tinggi_air') ?>" class="form-control">
          <p class="help-block text-red"><?php echo form_error('tinggi_air', ' ')?></p>
        </div>
        <div class="form-group">
          <label>Alamat*</label>
