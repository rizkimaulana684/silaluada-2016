      ...
      <div class="box-body">
        ...
        <form method="post" id="cekdatapengujian">
          ...
          <div class="col-md-12">
            ...
            <a href="<?php echo site_url('adm_situ') ?>" class="btn btn-default">Kembali</a>
          </div>
...
<script type="text/javascript">
  $("#cekdatapengujian").submit(function(e) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('adm_situ/cekdatapengujian') ?>",
  ...
  $("#uploadcsv").submit(function(e) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('adm_situ/importdata') ?>",
      enctype: 'multipart/form-data',
      contentType: false,
      cache: false,
      processData: false,
