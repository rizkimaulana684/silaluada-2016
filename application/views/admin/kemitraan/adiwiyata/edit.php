...
echo form_open_multipart('adm_adiwiyata/edit');
echo form_hidden('id',$item['sekolah_id']);
?>
<div class="box">
  <div class="box-header text-right">
      <button type="submit" class="btn btn-sm bg-orange"><i class="fa fa-save"></i> Simpan</button>
      <button type="reset" class="btn btn-sm btn-default"> Reset</button>
      <a href="<?php echo site_url('adm_adiwiyata')?>" class="btn btn-sm bg-grey">Kembali</a>
  </div>
</div>
<div class="row">
  <div class="col-md-7">
    <div class="box">
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" name="nama_sekolah" value="<?php echo $item['nama_sekolah']?>" class="form-control">
        </div>
        <div class="form-group">
          <label>Tahun Penghargaan</label>
          <input type="text" name="tahun_penghargaan" value="<?php echo $item['tahun_penghargaan']?>" class="form-control" id="dp2">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label>Klasifikasi Penghargaan</label><br/>
          <?php
          $s1 = ''; $s2 = ''; $s3='';
          if($item['nama_penghargaan']=="Adiwiyata Tingkat Kota/Provinsi") { 
            $s1= "checked"; 
          }
          elseif ($item['nama_penghargaan']=='Adiwiyata Tingkat Nasional') {
            $s2="checked";
           } 
          else{ 
            $s3= "checked"; 
          ...
          ?>
          <label><input type="radio" name="nama_penghargaan" value="Adiwiyata Tingkat Kota/Provinsi" <?php echo $s1; ?> > Tingkat Kota/Provinsi</label>
          <label style="margin-left:30px;"><input type="radio" name="nama_penghargaan" value="Adiwiyata Tingkat Nasional" <?php echo $s2; ?> > Tingkat Nasional</label>
          <label style="margin-left:30px;"><input type="radio" name="nama_penghargaan" value="Adiwiyata Tingkat Mandiri" <?php echo $s3; ?> > Tingkat Mandiri</label>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-5">
    <div class="box">
      <div class="box-body">
        ...
        <?php
        if($item['foto']!='') {
          echo "<img src='".base_url('uploads/ragamdata/kemitraan/adiwiyata/thumb/'.$item['foto'])."' />";
        }
        ?>
		<div class="form-group">
