...
echo form_open_multipart('adm_adiwiyata/tambah');
?>
<div class="box">
    ...
    <div class="box">
      <div class="box-body">
        <div class="form-group">
          ...
          <p class="help-block text-red"><?php echo form_error('nama_sekolah', ' ')?></p>
        </div>
        <div class="form-group">
          <label>Tahun Penghargaan</label>
          <input type="text" name="tahun_penghargaan" class="form-control" id="dp2">
        </div>
        <div class="form-group">
          <label>Alamat*</label>
