...
echo form_open_multipart('adm_adipura/tambah');
?>
<div class="box">
    ...
    <div class="box">
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" name="komponen" value="" class="form-control">
          <p class="help-block text-red"><?php echo form_error('komponen', ' ')?></p>
        </div>
        <div class="form-group">
