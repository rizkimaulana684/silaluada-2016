...
echo form_open_multipart('adm_sppl/tambah');
?>
<div class="box">
  ...
  <div class="col-md-7">
    <div class="box">
      <div class="box-body">
        ...
        <div class="form-group">
          <label>Tanggal</label>
          <input type="text" name="tanggal" value="<?php echo date('Y-m-d')?>" class="form-control" id="dp2">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="box">
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <textarea rows="4" class="form-control" name="alamat_perusahaan"></textarea>
        </div>
        <div class="form-group">
          <label>Nomor Telepon Perusahaan</label>
          <input type="text" name="no_telp_perusahaan" value="<?php echo set_value('no_telp_perusahaan') ?>" class="form-control">
          <p class="help-block text-red"><?php echo form_error('no_telp_perusahaan', ' ')?></p>
        </div>
        <div class="form-group">
          <label>Jenis Usaha/Sifat Usaha</label>
          <input type="text" name="jenis_usaha" value="<?php echo set_value('jenis_usaha') ?>" class="form-control">
          <p class="help-block text-red"><?php echo form_error('jenis_usaha', ' ')?></p>
        </div>
        <div class="form-group">
          <label>Kapasitas Produksi</label>
          <input type="text" name="kapasitas_produksi" value="<?php echo set_value('kapasitas_produksi') ?>" class="form-control">
          <p class="help-block text-red"><?php echo form_error('kapasitas_produksi', ' ')?></p>
        </div>
        <div class="form-group">
          <label>Luas Lahan + Luas Bangunan</label>
          <input type="text" name="luas_lahan" value="<?php echo set_value('luas_lahan') ?>" class="form-control">
          <p class="help-block text-red"><?php echo form_error('luas_lahan', ' ')?></p>
        </div>
        <div class="form-group">
          <label>Kondisi_lahan</label>
          <input type="text" name="kondisi_lahan" value="<?php echo set_value('kondisi_lahan') ?>" class="form-control">
