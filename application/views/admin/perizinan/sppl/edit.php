...
echo form_open_multipart('adm_sppl_baru/edit');
echo form_hidden('id',$item['sppl_id']);
?>
<div class="box">
    ...
    <div class="box">
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" name="tgl_sppl" value="<?php echo $item['tgl_sppl']?>" class="form-control" id="dp2">
        </div>
        <div class="form-group">
          <label>Nomor SPPL*</label>
          <input type="text" name="nomor_sppl" value="<?php echo $item['nomor_sppl'] ?>" class="form-control">
