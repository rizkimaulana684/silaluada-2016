...
echo form_open_multipart('adm_uklupl/tambah');
?>
<div class="box">
    ...
    <div class="box">
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" name="nomor_surat" value="<?php echo set_value('nomor_surat') ?>" class="form-control">
          <p class="help-block text-red"><?php echo form_error('nomor_surat', ' ')?></p>
        </div>
        <div class="form-group">
          <label>Tanggal Surat*</label>
          <input type="text" name="tgl_surat" value="<?php echo date('Y-m-d')?>" class="form-control" id="dp2">
        </div>
        <div class="form-group">
          <label>Tahun*</label>
    ...
    <div class="box">
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="konsultan" value="<?php echo set_value('konsultan') ?>" class="form-control">
          <p class="help-block text-red"><?php echo form_error('konsultan', ' ')?></p>
        </div>
         <div class="form-group">
          <label>Keterangan</label>
          <input type="text" name="keterangan" value="<?php echo set_value('keterangan') ?>" class="form-control">
