...
echo form_open_multipart('adm_amdal/edit');
echo form_hidden('id',$item['amdal_id']);
?>
<div class="box">
  <div class="box-header text-right">
      <button type="submit" class="btn btn-sm bg-orange"><i class="fa fa-save"></i> Simpan</button>
      <button type="reset" class="btn btn-sm btn-default"> Reset</button>
      <a href="<?php echo site_url('adm_amdal')?>" class="btn btn-sm bg-grey">Kembali</a>
  </div>
</div>
<div class="row">
  <div class="col-md-7">
    <div class="box">
      <div class="box-body">
        ...
        <div class="form-group">
          <label>Tahun*</label>
          <input type="text" name="tahun" value="<?php echo $item['tahun']?>" class="form-control" id="dp2">
        ...
        <div class="form-group">
          <label>KA-AMDAL</label>
          <input type="text" name="rekom_kaamdal" value="<?php echo $item['rekom_kaamdal'] ?>" class="form-control">
        </div>
        <div class="form-group">
          <label>AMDAL</label>
          <input type="text" name="rekom_amdal" value="<?php echo $item['rekom_amdal'] ?>" class="form-control">
        </div>
        <div class="form-group">
          <label>Keterangan</label>
          <textarea rows="4" class="form-control" name="keterangan"><?php echo $item['keterangan']?></textarea>
        </div>
      </div>
    </div>
  </div>
