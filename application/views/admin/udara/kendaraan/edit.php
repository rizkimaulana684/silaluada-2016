...
echo form_open_multipart('adm_kendaraan/edit');
echo form_hidden('id',$item['kendaraan_id']);
?>
<div class="box">
    ...
    <div class="box">
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" name="tahun_pengujian" value="<?php echo $item['tahun_pengujian']?>" class="form-control" id="dp2">
        </div>
        <div class="form-group">
          <label>Jumlah Kendaraan*</label>
          <input type="text" name="jumlah_kendaraan" value="<?php echo $item['jumlah_kendaraan']?>" class="form-control">
        </div>
        <div class="form-group">
          <label>Bahan Bakar</label><br/>
          <?php
          $s1 = ''; $s2 = '';
          if($item['bahan_bakar']=="Bensin") { $s1= "checked"; }
          else { $s2= "checked"; }
          ?>
          <label><input type="radio" name="bahan_bakar" value="bensin" <?php echo $s1; ?> > Bensin</label>
          <label style="margin-left:30px;"><input type="radio" name="bahan_bakar" value="Solar" <?php echo $s2; ?> > Solar</label>
        </div>
         <div class="form-group">
          <label>Kendaraan Lulus Uji*</label>
          <input type="text" name="kendaraan_lulus_uji" value="<?php echo $item['kendaraan_lulus_uji']?>" class="form-control">
        </div>
         <div class="form-group">
          <label>Kendaraan Tidak Lulus Uji*</label>
          <input type="text" name="kendaraan_tidak_lulus_uji" value="<?php echo $item['kendaraan_tidak_lulus_uji']?>" class="form-control">
        </div>
        <div class="form-group">
