...
echo form_open_multipart('adm_tanah/edit_tahunuji');
?>
    <div class="box">
      <div class="box-body">
      <div class="row">
        <div class="col-md-4 form-group">
          ...
          <input type="text" name="tahun" class="form-control" value="<?php echo $dt['tahunuji_tanah'] ?>">
        ...
        <a href="<?php echo site_url('adm_tanah') ?>" class="btn bg-green">Kembali</a>
        </div>
      </div>
      </div>
    </div>
