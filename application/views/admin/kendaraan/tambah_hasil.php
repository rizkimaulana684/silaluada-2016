      ...
      <div class="box-body">
        ...
        <form method="post" id="cekdatapengujian">
          ...
          <div class="col-md-12 form-group">
            <select name="lokasiuji" class="form-control" id="lokasiuji">
              ...
              foreach ($lokasiuji->result() as $row) {
                echo '<option value="'.$row->lokasiuji_kendaraan_id.'">'.$row->nama_lokasi.'</option>';
              }
              ?>
            </select>
          ...
          <div class="col-md-12">
            ...
            <a href="<?php echo site_url('adm_kendaraan') ?>" class="btn btn-default">Kembali</a>
          </div>
        </form>
        </div>
...
<script type="text/javascript">
  $("#cekdatapengujian").submit(function(e) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('adm_kendaraan/cekdatapengujian') ?>",
  ...
  $("#uploadcsv").submit(function(e) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('adm_kendaraan/importdata') ?>",
      enctype: 'multipart/form-data',
      contentType: false,
      cache: false,
      processData: false,
