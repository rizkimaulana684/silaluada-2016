...
echo form_open_multipart('adm_kendaraan/tmb_emisi');
?>
    <div class="box">
      <div class="box-body">
      <div class="row">
        <div class="col-md-4 form-group">
          ...
          <input type="text" name="tahunuji" class="form-control">
      ...
      <div class="row">
        <div class="col-md-6 form-group">
          ...
          <input type="text" name="lokasiuji" class="form-control">
      ...
      <div class="row">
        <div class="col-md-3 form-group">
          ...
          <input type="text" name="jum_kdr_bensin" class="form-control" placeholder="Jumlah Kendaraan">
        </div>
        <div class="col-md-3 form-group">
        <label>Jumlah Lulus</label>
          <input type="text" name="bensin_lulus" class="form-control" placeholder="Jumlah Lulus">
        </div>
        <div class="col-md-3 form-group">
        <label>Jumlah Tidak Lulus</label>
          <input type="text" name="bensin_non_lulus" class="form-control" placeholder="Jumlah Tidak Lulus">
        </div>
      </div>
      <div class="row">
        <div class="col-md-3 form-group">
          <label>Jumlah Kendaraan (Solar)</label>
          <input type="text" name="jum_kdr_solar" class="form-control" placeholder="Jumlah Kendaraan">
        </div>
        <div class="col-md-3 form-group">
        <label>Jumlah Lulus</label>
          <input type="text" name="solar_lulus" class="form-control" placeholder="Jumlah Lulus">
        </div>
        <div class="col-md-3 form-group">
        <label>Jumlah Tidak Lulus</label>
          <input type="text" name="solar_non_lulus" class="form-control" placeholder="Jumlah Tidak Lulus">
        </div>
      </div>
      <div class="row">
