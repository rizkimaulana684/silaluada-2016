...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo site_url('adm_ambien/lokasiuji')?>">Pengujian</a></li>
...
echo form_open_multipart('adm_ambien/tmb_lokasiuji');
?>
<div class="box">
  <div class="box-header text-right">
      <button type="submit" class="btn btn-sm bg-orange"><i class="fa fa-save"></i> Simpan</button>
      <button type="reset" class="btn btn-sm btn-default"> Reset</button>
      <a href="<?php echo site_url('adm_ambien/lokasiuji')?>" class="btn btn-sm bg-grey">Kembali</a>
  </div>
</div>
<div class="row">
  ...
  <div class="col-md-6">
    ...
    <p> </p>
    <p><b><font face="Arial" font size="3px" font color="red">*Contoh Format Penulisan Keterangan</font></b></p>
    <p><b><font face="Arial">Data Lokasi Pengujian ambien</font></b></p>
