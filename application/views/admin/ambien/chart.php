    ...
    <div class="col-md-12">
      ...
      <div class="box box-success">
        <div class="box-header with-border">
          <form class="box-title" method="get" action="<?php echo site_url('adm_ambien/chart') ?>">
            <select name="tahun">
              <option value="">- Pilih Tahun -</option>
              <?php
              foreach ($tahun->result() as $t) {
                $s = '';
                if($t->tahunuji_ambien==$this->input->get('tahun')) {
                  $s = 'selected';
                }
        ...
        <div class="box-body">
          ...
          <canvas id="barChart" height="630"></canvas>
        </div><!-- /.box-body -->
          ...
          datasets: [
            {
              ...
              <?php
              foreach ($lokasi->result() as $l) {
                echo hasil_uji_ambien(array('lokasiuji_ambien_id'=>$l->lokasiuji_ambien_id,'tahunuji_ambien'=>$thn,'b.par_ambien_id'=>$idp));
                echo ","; 
              }
              ?>
              ]
