...
echo form_open_multipart('adm_ambien/edit_tahunuji');
?>
    <div class="box">
      <div class="box-body">
      <div class="row">
        <div class="col-md-4 form-group">
          ...
          <input type="text" name="tahun" class="form-control" value="<?php echo $dt['tahunuji_ambien'] ?>">
        ...
        <a href="<?php echo site_url('adm_ambien') ?>" class="btn bg-green">Kembali</a>
        </div>
      </div>
      </div>
    </div>
