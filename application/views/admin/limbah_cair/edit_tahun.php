...
echo form_open_multipart('adm_limbah_cair/edit_tahunuji');
?>
    <div class="box">
      <div class="box-body">
      <div class="row">
        <div class="col-md-4 form-group">
          ...
          <input type="text" name="tahun" class="form-control" value="<?php echo $dt['tahunuji_limbah_cair'] ?>">
          <p class="help-block text-red"><?php echo form_error('tahun', ' ')?></p>
        </div>
        <div class="col-md-12 form-group">
          <label>Keterangan</label>
          <textarea class="form-control" rows="6" name="keterangan" id="editor1"><?php echo $dt['keterangan'] ?></textarea>
        ...
        <a href="<?php echo site_url('adm_limbah_cair') ?>" class="btn bg-green">Kembali</a>
        </div>
      </div>
      </div>
    </div>
