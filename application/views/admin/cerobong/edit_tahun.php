...
echo form_open_multipart('adm_cerobong/edit_tahunuji');
?>
    <div class="box">
      <div class="box-body">
      <div class="row">
        <div class="col-md-4 form-group">
          ...
          <input type="text" name="tahun" class="form-control" value="<?php echo $dt['tahunuji_cerobong'] ?>">
        ...
        <a href="<?php echo site_url('adm_cerobong') ?>" class="btn bg-green">Kembali</a>
        </div>
      </div>
      </div>
    </div>
