<div class="pull-right" style="padding:5px;"><a href="<?php echo site_url('ragam_data/export_limbah_cair?thn='.$thn.'&lks='.$lks) ?>" class="btn btn-xs btn-success btn-flat">EXPORT</a></div>
<table cellpadding="0" cellspacing="0" width="100%" border="1">
	<thead style="background:#3366FF;">
		<tr><th align="center" colspan="2">Pengujian Limbah Cair Tahun <?php echo $thn ?> Lokasi <?php echo nama_lokasi('lokasiuji_limbah_cair',$lks,'nama_lokasi') ?></th></tr>
