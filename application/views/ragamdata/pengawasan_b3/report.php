<div class="pull-right" style="padding:5px;"><a href="<?php echo site_url('ragam_data/export_pengawasan_b3?jenis='.$jenis) ?>" class="btn btn-xs btn-success btn-flat">EXPORT</a></div>
