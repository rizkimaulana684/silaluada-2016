...
<div class="wrap">
	<table width="100%" cellpadding="0" cellspacing="0">
		...
		<tr class="odd">
			<td valign="top">Luasan</td>
			<td valign="top">:</td>
			<td><?php echo $dt['luasan'];?></td>
		</tr>
		<tr class="add">
			<td valign="top">Jenis Tanaman</td>
			<td valign="top">:</td>
			<td><?php echo $dt['jenis_tanaman'];?></td>
		</tr>
		<tr class="odd">
			<td>Kelurahan</td>
			<td>:</td>
		...
		<tr class="add">
			...
			<td>
				...
				if($dt['foto']!=null) {
					?>
					<img src="<?php echo base_url('uploads/ragamdata/hutan/'.$dt['foto']) ?>" width="200">
					<?php
				}
				?>
			</td>
