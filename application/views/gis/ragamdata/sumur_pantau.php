...
<div class="wrap">
	<table width="100%" cellpadding="0" cellspacing="0">
		...
		<tr class="add">
			<td valign="top">Ketinggian Air</td>
			<td valign="top">:</td>
			<td><?php echo $dt['tinggi_air'];?></td>
		</tr>
		<tr class="odd">
			<td>Kelurahan</td>
			<td>:</td>
		...
		<tr class="odd">
			...
			<td>
				...
				if($dt['foto']!=null) {
					?>
					<img src="<?php echo base_url('uploads/ragamdata/konservasi/sumur_pantau/'.$dt['foto']) ?>" width="200">
					<?php
				}
				?>
			</td>
