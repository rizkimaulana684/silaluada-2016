	<!-- KONTEN -->
					<div class="col-md-8 col-sm-8 right-padding-5" style="">
						<div style="background:#fff; padding:3%;box-radius:50px; ">
							      <h4>Dokumen Perusahaan</h4><br>
							    	<!-- Form perusahaan -->
							    		<form method="POST" action="<?php echo site_url('dokumen_perusahaan/tampil')?>" enctype="multipart/form-data"> 
								    		<table class="table">
								    			<tr>
	...
	<script>
		$(document).ready(function(){
			$.post("<?php echo site_url('dokumen_perusahaan/tampil') ?>",{perusahaan_id:$("#optionPerusahaan option:selected").val() }, function(aksi){
