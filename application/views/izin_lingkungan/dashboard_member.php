							      ...
							      <h3>Dashboard</h3>
							    	<!-- Dashboard -->
							    		<div style="text-align:right; margin-bottom:2%; margin-top:2%;">
							    			<a data-toggle="modal" data-target="#myModal" class="btn btn-primary">Buat Izin Baru</a>
							    		</div>
												    		...
												    		<table class="table table-bordered table-striped" id="example1">
													    		...
													    		?>
													    			<tr>
													    				...
													    				<td>
													    					<a href="<?php echo site_url()."/perizinan_lingkungan/edit/".$r->permohonan_id."/".$r->jenisizin_id?>"  class="btn btn-warning">Edit</a>
													    					<a href="<?php echo site_url()."/upload_syarat/index/".$r->pemohon_id."/".$r->perusahaan_id."/".$r->jenisizin_id."/".$r->permohonan_id?>"  class="btn btn-info">Buka</a>
													    				</td>
													    			</tr>
													    		<?php }} ?>
												    		</table>
